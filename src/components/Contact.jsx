...
const Contact = () => {
  return (
    <div name='contact' className='w-full bg-2  justify-center items-center p-4 h-screen'>
        <form method='POST' action="https://getform.io/f/bdc8d9d0-3c8b-4f6d-b86b-bd9dbefcd1f7" className='flex flex-col max-w-[1000px] mx-auto w-full'>
            ...
            <input className='my-4 p-3 bg-white rounded-sm' type="email" placeholder='Enter your email' name='email' />
